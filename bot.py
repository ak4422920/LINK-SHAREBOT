...
name = """
Link share bot started ✨ Credit:- @AkMovieVerse
"""
...
class Bot(Client):
    ...
    async def start(self, *args, **kwargs):
        ...
        try:
            await self.send_photo(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[InlineKeyboardButton("ᴜᴘᴅᴀᴛᴇs", url="https://t.me/AkMovieVerse")]]
                    )
                )
        ...
        self.LOGGER(__name__).info("Wew...Bot is running...⚡  Credit:- @AkMovieVerse")
